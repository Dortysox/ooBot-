...
module.exports.run = async (client, message, args) => {
        ...
        let member = db.fetch(`money_${user.id}_${message.guild.id}`)
        ...
        if (args[0] == 'all') {
            ...
            db.subtract(`money_${user.id}_${message.guild.id}`, money)
            db.add(`bank_${user.id}_${message.guild.id}`, money)
            ...
            db.add(`bank_${user.id}_${message.guild.id}`, args[0])
